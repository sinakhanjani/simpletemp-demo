...
import com.simpletempco.simpletemp.databinding.ActivityDentalTempBinding
...
@AndroidEntryPoint
class DentalTempActivity : BaseActivity() {

    private lateinit var appBarConfiguration: AppBarConfiguration
    private lateinit var navHost: NavHostFragment
    private lateinit var navController: NavController

    private val viewModel: DentalTempViewModel by viewModels()

    private lateinit var binding: ActivityDentalTempBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityDentalTempBinding.inflate(layoutInflater)
